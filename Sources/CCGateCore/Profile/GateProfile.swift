...
public struct GateProfile {
    ...
    private let hookBinaryOverride: String?
    ...
    public init(serviceAccount: String, accountRealName: String, namespace: String,
                ...
                claudeCodeDir: String, managedSettings: String, hookBinary: String? = nil) {
        ...
        self.hookBinaryOverride = hookBinary
    }
    ...
    public var hookBinary: String { hookBinaryOverride ?? (codeDir + "/" + binaryName) }
